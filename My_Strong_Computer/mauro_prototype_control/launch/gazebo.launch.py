...
def generate_launch_description():
    ...
    # package_share_directory = get_package_share_directory('mauro_prototype_control')

    #config_file_path = os.path.join(get_package_share_directory('mauro_prototype_control'), 'config', 'joint_controller.yaml')
